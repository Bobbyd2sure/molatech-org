      ...
      <div className="container px-4 md:px-6 relative z-10">
        ...
        >
          <div className="space-y-2">
            <motion.h2
              className="text-3xl font-medium font-heading tracking-tighter sm:text-5xl bg-gradient-to-r from-blue-600 to-blue-500 bg-clip-text text-transparent"
          ...
          {filteredProjects.map((project, index) => (
            ...
            >
              <CardContainer className="inter-var h-full">
                <CardBody className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-blue-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-full h-auto rounded-xl border overflow-hidden">
                  {/* Project Image */}
                    ...
                    <div className="relative w-full aspect-video overflow-hidden">
                      ...
                      <div className="absolute inset-0 bg-gradient-to-t from-black/60 via-black/30 to-transparent opacity-0 group-hover/card:opacity-100 transition-opacity duration-300">
                        <div className="absolute bottom-4 left-4">
                          <Badge
                            className="bg-gradient-to-r from-blue-500/90 to-blue-500/90 text-white border-0"
                            variant="secondary"
                          >
                  ...
                  <div className="p-6">
                    <CardItem translateZ="60" className="mb-2">
                      <h3 className="text-xl font-medium font-heading">{project.title}</h3>
                    </CardItem>
                    ...
                    <CardItem translateZ="80" className="mt-auto">
                      <div className="flex gap-2">
                        <Modal>
                          <ModalTrigger className="flex-1 bg-gradient-to-r from-blue-500 to-blue-500 hover:from-blue-600 hover:to-blue-600 text-white px-4 py-2 rounded-lg font-medium transition-all duration-300 text-center">
                            View Details
                          </ModalTrigger>
                          <ModalBody>
                            <ModalContent>
                              ...
                              >
                                <div className="flex items-center gap-2 mb-2">
                                  <Badge
                                    variant="secondary"
                                    className="bg-gradient-to-r from-blue-500/10 to-blue-500/10 text-blue-700 dark:text-blue-300"
                                  >
                                    {project.categoryLabel}
                                  </Badge>
                                  <Badge variant="outline">Featured Project</Badge>
                                </div>
                                <h2 className="text-2xl md:text-3xl font-medium font-heading text-neutral-800 dark:text-neutral-200 mb-2">
                                  {project.title}
                                </h2>
                                ...
                                <div>
                                  ...
                                  <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                                    {project.metrics.map((metric, index) => (
                                      ...
                                      >
                                        <div className="text-xl font-medium font-heading text-blue-600 dark:text-blue-400">
                                          {metric.value}
                                        </div>
                        ...
                        <MagneticHover strength={0.1}>
                          <Button
                            ...
                            variant="outline"
                            size="icon"
                            className="rounded-lg border-blue-500/20 hover:bg-blue-500/10 bg-transparent"
                          >
                            <Link href={project.liveUrl}>
        ...
        >
          <div className="bg-muted/30 p-6 rounded-xl border border-muted text-center">
            ...
            <div className="text-3xl font-medium font-heading mb-1 bg-gradient-to-r from-blue-600 to-blue-500 bg-clip-text text-transparent">
              150+
            </div>
          ...
          <div className="bg-muted/30 p-6 rounded-xl border border-muted text-center">
            ...
            <div className="text-3xl font-medium font-heading mb-1 bg-gradient-to-r from-green-600 to-blue-500 bg-clip-text text-transparent">
              12
            </div>
          ...
          <div className="bg-muted/30 p-6 rounded-xl border border-muted text-center">
            ...
            <div className="text-3xl font-medium font-heading mb-1 bg-gradient-to-r from-cyan-600 to-blue-500 bg-clip-text text-transparent">
              24/7
            </div>
        ...
        >
          <MagneticHover strength={0.2}>
            <Button
              asChild
              size="lg"
              className="bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 text-white border-0 shadow-lg group"
            >
              <Link href="/projects">
                View All Projects
