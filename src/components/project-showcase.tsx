...
export default function ProjectShowcase() {
  ...
  const categories = [
    { id: "all", name: "All Projects", color: "from-blue-500 to-blue-500" },
    { id: "web-development", name: "Web Development", color: "from-green-500 to-emerald-500" },
    { id: "app-development", name: "App Development", color: "from-orange-500 to-red-500" },
    { id: "website-design", name: "Website Design", color: "from-cyan-500 to-blue-500" },
  ]
  ...
  const cardItems = projects.map((project) => ({
    ...
    content: (
      <MagneticHover strength={0.2}>
        <Card className="w-[300px] overflow-hidden transition-all hover:shadow-2xl hover:shadow-blue-500/20 border-0 bg-gradient-to-br from-background to-muted">
          <div className="aspect-video relative overflow-hidden">
            ...
            <div className="absolute top-2 right-2">
              <span className="px-2 py-1 text-xs font-medium rounded-full bg-gradient-to-r from-blue-500/80 to-blue-500/80 text-white backdrop-blur-sm">
                {categories
      ...
      <div className="container px-4 md:px-6 relative z-10">
        ...
        >
          <div className="space-y-2">
            <motion.h2
              className="text-3xl font-medium font-heading tracking-tighter sm:text-5xl bg-gradient-to-r from-blue-600 via-blue-500 to-emerald-400 bg-clip-text text-transparent"
          ...
          {currentProjects.map((project, index) => (
            ...
            >
              <CardContainer className="inter-var h-full">
                <CardBody className="bg-gray-50 relative group/card dark:hover:shadow-2xl dark:hover:shadow-blue-500/[0.1] dark:bg-black dark:border-white/[0.2] border-black/[0.1] w-full h-auto rounded-xl border">
                  <div className="relative overflow-hidden rounded-xl">
                    ...
                    <CardItem translateZ="100" className="w-full">
                      <div className="aspect-video relative overflow-hidden rounded-lg">
                        ...
                        >
                          <div className="flex gap-2 w-full">
                            <MagneticHover strength={0.1} className="flex-1">
                              <Button size="sm" variant="subtle" className="w-full backdrop-blur-sm">
                                <ExternalLink className="h-3 w-3 mr-1" />
                                Live Demo
                              </Button>
                            </MagneticHover>
                        ...
                        <CardItem translateZ="80" className="absolute top-2 right-2">
                          <span className="px-2 py-1 text-xs font-medium rounded-full bg-gradient-to-r from-blue-500/90 to-blue-500/90 text-white backdrop-blur-sm">
                            {categories
                              .find((c) => c.id === project.category)
                              ?.name.replace(" Development", "")
                              .replace(" Design", "")}
                    ...
                    <div className="p-6">
                      <CardItem translateZ="60" className="mb-2">
                        <h3 className="text-xl font-medium font-heading bg-gradient-to-r from-foreground to-muted-foreground bg-clip-text text-transparent">
                          {project.title}
                        </h3>
                      </CardItem>
              ...
              {Array.from({ length: totalPages }, (_, i) => (
                <motion.button
                  ...
                  className={cn(
                    ...
                    currentPage === i
                      ? "bg-gradient-to-r from-blue-500 to-blue-500 w-8"
        ...
        >
          <MagneticHover strength={0.2}>
            <div className="relative inline-block">
              <div className="absolute -inset-1 bg-gradient-to-r from-blue-600 via-blue-500 to-emerald-400 rounded-lg blur opacity-75 group-hover:opacity-100 transition duration-1000 group-hover:duration-200 animate-pulse"></div>
              <Button
                size="lg"
                className="relative bg-gradient-to-r from-blue-600 to-blue-500 hover:from-blue-700 hover:to-blue-600 text-white border-0 shadow-lg"
              >
