...
export default function CompanyHistory() {
  const milestones = [
    ...
    },
    {
      ...
      description:
        "Delivered our first client engagements — web builds and security assessments for small and mid-market businesses.",
    },
    {
      year: "2023",
      title: "Team Expansion",
      description: "Established our three service lines — Build, Secure, Automate — delivered senior-led with fixed-scope pricing.",
    },
    {
      year: "2024",
      ...
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center mb-10">
          <div className="space-y-2">
            <h2 className="text-3xl font-medium font-heading tracking-tighter sm:text-4xl">Our Journey</h2>
                  ...
                  <div className={`w-full md:max-w-md ${index % 2 === 0 ? "md:ml-auto" : "md:mr-auto"}`}>
                    <Card className="h-full">
                      <CardContent className="p-6">
                        ...
                        <h3 className="text-xl font-medium font-heading mb-2">{milestone.title}</h3>
