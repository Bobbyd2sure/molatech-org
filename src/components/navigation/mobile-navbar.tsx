                ...
                <SheetContent className="w-screen">
                    ...
                    <div className="flex flex-col items-start w-full py-2 mt-10">
                        <div className="flex items-center justify-evenly w-full space-x-2">
                            <Link href="/start" onClick={handleClose} className={buttonVariants({ variant: "outline", className: "w-full" })}>
                                Get Started
                            </Link>
                            <Link href="/book" onClick={handleClose} className={cn(buttonVariants({ className: "w-full" }), "bg-emerald-500 hover:bg-emerald-600 text-white")}>
                                Book a Call
                            </Link>
                        </div>
