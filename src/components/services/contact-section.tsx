      ...
      <div className="container px-4 md:px-6">
        <div className="flex flex-col items-center justify-center space-y-4 text-center mb-10">
          <div className="space-y-2">
            <h2 className="text-3xl font-medium font-heading tracking-tighter sm:text-4xl">Get In Touch</h2>
            ...
            <div className="grid gap-6">
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">{COMPANY.emails.info}</p>
                  <p className="text-muted-foreground">{COMPANY.emails.support}</p>
                </div>
              </div>
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <p className="text-muted-foreground">{COMPANY.address.street}</p>
                  <p className="text-muted-foreground">{COMPANY.address.city}, {COMPANY.address.state} {COMPANY.address.zip}</p>
                </div>
              </div>
