...
import { AnimateOnScroll, AnimateOnLoad } from "@/components/motion-wrapper"
...
const CardContainer = dynamic(
  () => import("@/components/ui/aceternity/3d-card").then((mod) => mod.CardContainer),
  { ssr: false }
)
const CardBody = dynamic(
  () => import("@/components/ui/aceternity/3d-card").then((mod) => mod.CardBody),
  { ssr: false }
)
const CardItem = dynamic(
  () => import("@/components/ui/aceternity/3d-card").then((mod) => mod.CardItem),
  { ssr: false }
)
const FloatingParticles = dynamic(
  () => import("@/components/ui/aceternity/floating-particles").then((mod) => mod.FloatingParticles),
  { ssr: false }
)
const MagneticHover = dynamic(
  () => import("@/components/ui/aceternity/magnetic-hover").then((mod) => mod.MagneticHover),
  { ssr: false }
)
...
export default function ServicesPage() {
  ...
  return (
    <GsapEffects className="min-h-screen relative overflow-hidden">
      {/* Background Effects */}
      ...
      <div className="container mx-auto px-4 py-12 md:py-24 relative z-10">
        ...
        <div className="text-center mb-16">
          <h1 className="text-4xl md:text-6xl font-medium font-heading mb-6">
            {["Our", "Services"].map((word, i) => (
              <span
                key={i}
                className="hero-word inline-block bg-gradient-to-r from-cyan-600 via-blue-500 to-cyan-400 bg-clip-text text-transparent"
              >
                {word}{"\u00A0"}
              </span>
            ))}
        ...
        {/* Service Navigation */}
        <AnimateOnLoad delay={0.2} className="mb-12">
              ...
              >
                ...
                <div className="relative z-10">
                  <div className="flex items-center gap-4 mb-6">
                    ...
                    <div>
                      <h2 className="text-3xl font-medium font-heading">{currentService.title}</h2>
        ...
        {/* Service Comparison */}
        <AnimateOnScroll delay={0.6} className="mb-16">
          <h2 className="text-3xl font-medium font-heading text-center mb-8 bg-gradient-to-r from-cyan-600 to-blue-500 bg-clip-text text-transparent">
            Service Comparison
          </h2>
        ...
        {/* Call to Action */}
        <AnimateOnScroll delay={0.8} className="text-center">
          <div className="bg-gradient-to-r from-cyan-600 to-blue-500 rounded-2xl p-8 text-white">
            <h2 className="text-3xl font-medium font-heading mb-4">Ready to Get Started?</h2>
