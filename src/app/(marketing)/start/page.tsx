...
export default function StartPage() {
  return (
    <GsapEffects className="container mx-auto px-4 py-12 md:py-24">
      <div className="max-w-5xl mx-auto">
        <div className="text-center mb-12">
          <h1 className="text-4xl font-medium font-heading mb-4">
          ...
          <p className="hero-reveal text-xl text-muted-foreground max-w-2xl mx-auto">
