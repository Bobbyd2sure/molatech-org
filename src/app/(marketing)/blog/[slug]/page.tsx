...
export default async function BlogPostPage({ params }: PageProps) {
  ...
  return (
    <article className="min-h-screen">
      ...
      <header className="w-full py-12 md:py-24 bg-gradient-to-b from-background to-muted/20">
        <div className="container px-4 md:px-6 max-w-4xl">
          ...
          <div className="space-y-4">
            ...
            <h1 className="text-3xl font-medium font-heading tracking-tighter sm:text-4xl md:text-5xl">
              {post.title}
            </h1>
      ...
      <div className="container px-4 md:px-6 max-w-4xl py-12">
        <div className="prose prose-lg dark:prose-invert max-w-none">
          ...
          {post.content.split("\n").map((line, index) => {
            ...
            if (line.startsWith("# ")) {
              return (
                <h1 key={index} className="text-3xl font-medium font-heading mt-8 mb-4">
                  {line.slice(2)}
                </h1>
              )
            }
            if (line.startsWith("## ")) {
              return (
                <h2 key={index} className="text-2xl font-medium font-heading mt-6 mb-3">
                  {line.slice(3)}
                </h2>
              )
            }
            if (line.startsWith("### ")) {
              return (
                <h3 key={index} className="text-xl font-medium font-heading mt-4 mb-2">
                  {line.slice(4)}
                </h3>
              )
            }
      ...
      {/* CTA */}
      <section className="w-full py-12 bg-gradient-to-r from-cyan-600 to-blue-500">
